...
export default function HalfDonut(props: { valueColor?: string; emptyColor?: string; valueBorderColor?: string; emptyBorderColor?: string; value: number; height?: number; width?: number; }) {
