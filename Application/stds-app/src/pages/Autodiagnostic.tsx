...
const Autodiagnostic = () => {
    ...
    const diagErrors: ErrorFormat = {
        errorLevel: datas.diag2 === "MQTT 2 déconnecté" ? 2 : 0,
        message: datas.diag2 === "MQTT 2 déconnecté" ? "MQTT 2 déconnecté" : "MQTT Connecté",
        pdf: "",
    }
        ...
        <IonPage id="puissance-page">
            ...
            <IonContent fullscreen>
                <Box sx={{width: '90%', margin: 'auto'}}>
                    ...
                    <CompleteAlert error={tempErrors.temp2} />
                    <br/>
                    <Typography sx={{textAlign: "left",fontWeight: "bold",fontSize: 20,marginBottom: 1}}>
                        Température ambiante
                    </Typography>
                    <CompleteAlert error={tempErrors.temp1} />
                    <br/>
                    <Typography sx={{textAlign: "left",fontWeight: "bold",fontSize: 20,marginBottom: 1}}>
                        Quantité de bière
                    </Typography>
                    <CompleteAlert error={qteErrors} />
                    <br/>
                    <Typography sx={{textAlign: "left",fontWeight: "bold",fontSize: 20,marginBottom: 1}}>
                        Puissance
                    </Typography>
                    <CompleteAlert error={puissanceErrors} />
                    <br/>
                    <Typography sx={{textAlign: "left",fontWeight: "bold",fontSize: 20,marginBottom: 1}}>
                        CO2
                    </Typography>
                    <CompleteAlert error={co2Errors} />
                </Box>
            </IonContent>
        </IonPage>
    )
